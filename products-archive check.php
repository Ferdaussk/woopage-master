<?php
/**
 * Plugin Name: Products Archive
 * Description: Products Archive plugin is an product single page for enables customer to have a quick look of product without visiting product page.
* Plugin URI: https://bestwpdeveloper.com/shop/
* Version: 1.0
* Author: Best WP Developer
* Author URI: https://bestwpdeveloper.com/
* Text Domain: products-archive
*/
